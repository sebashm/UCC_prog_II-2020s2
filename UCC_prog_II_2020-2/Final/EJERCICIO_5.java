...
public class EJERCICIO_5 {
	public static void main (String[] args){
    	...
    	System.out.println("Digite la cantidad entregada por el cliente: ");
    	b= scan.next();
    	bN= (int) Double.parseDouble(b);
    	
    	
    	double valorxentregar = (double) ((aN-bN));
    	
    	System.out.println("El valorxentregar es: " +valorxentregar);
